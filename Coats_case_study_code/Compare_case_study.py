...
kdiff_df = kdiff_df.drop(['init x', 'init y', 'init z', 'dist btw frts',
...
plot_crack_len_vs_height(kdiff_df, 'crack len', 'height', case_study_df, 'Final True Line Length (mm)', 'BC height')
