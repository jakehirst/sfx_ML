...
class MNISTSequence(tf.keras.utils.Sequence):
  ...
  def __init__(self, data=None, batch_size=5, fake_data_size=None):
...
#COMMENT custom code
def get_sfx_data(batch_size=1, num_folds=5, k=4, num_tries=50, folder="/Users/jakehirst/Desktop/sfx/bayesian_tests"):
    ...
    train_df = add_augmentations_clustering(train_df, augmentation_list)
