...
saving_folder=f'/Users/jakehirst/Desktop/model_results/MODEL_COMPARISONS/Ridge_Reg_{label_to_predict}/'
...
raw_images = []
Kfold_Ridge_Regression(alpha, correlated_featureset, raw_images, full_dataset_labels, important_features, saving_folder, label_to_predict)
